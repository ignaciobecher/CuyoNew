<template>
    ...
    <div class="hero-content">
      <div class="hero-text">
        ...
        <h1 class="hero-title">
          ...
          <span class="title-line highlight">SOLUCIONES</span>
  ...
  <a href="https://wa.link/jajbyw" class="whatsapp-float" target="_blank">
    ...
    <div class="whatsapp-tooltip">¡Hablemos!</div>
  </a>
</template>
...
.badge {
  ...
  background: rgba(12, 195, 155, 0.15);
  color: #0cc39b;
  border-radius: 50px;
  font-size: 0.9rem;
  font-weight: 600;
...
.title-line.highlight {
  color: #0cc39b;
  text-shadow: 0 0 30px rgba(12, 195, 155, 0.3);
}
...
.cta-button.primary {
  ...
  color: #2a0878;
  box-shadow: 0 8px 30px rgba(12, 195, 155, 0.25);
}

.cta-button.primary:hover {
  transform: translateY(-3px);
  box-shadow: 0 12px 40px rgba(12, 195, 155, 0.35);
}
...
.floating-card {
  ...
  border-radius: 16px;
  padding: 1.5rem;
  box-shadow: 0 8px 32px rgba(42, 8, 120, 0.15);
...
.stat-number {
  ...
  text-shadow: 0 0 20px rgba(12, 195, 155, 0.3);
}
